...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTOPLANTILLA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EVENTOPLANTILLA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EVENTOPLANTILLA actions', async () => {
      const arg = { id: 29383 };
    ...
    it('dispatches UPDATE_EVENTOPLANTILLA actions', async () => {
      const arg = { id: 29383 };
    ...
    it('dispatches PARTIAL_UPDATE_EVENTOPLANTILLA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EVENTOPLANTILLA actions', async () => {
      const arg = 42666;
