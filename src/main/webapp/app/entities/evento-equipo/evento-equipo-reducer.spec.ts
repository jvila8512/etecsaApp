...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTOEQUIPO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EVENTOEQUIPO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EVENTOEQUIPO actions', async () => {
      const arg = { id: 6359 };
    ...
    it('dispatches UPDATE_EVENTOEQUIPO actions', async () => {
      const arg = { id: 6359 };
    ...
    it('dispatches PARTIAL_UPDATE_EVENTOEQUIPO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EVENTOEQUIPO actions', async () => {
      const arg = 42666;
