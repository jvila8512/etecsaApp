...
export const EventoEquipoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="eventoEquipoDeleteDialogHeading">
        <Translate contentKey="entity.delete.title">Confirm delete operation</Translate>
      </ModalHeader>
      <ModalBody id="appsupervisorApp.eventoEquipo.delete.question">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-eventoEquipo" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
