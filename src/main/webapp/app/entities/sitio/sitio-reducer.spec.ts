...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './sitio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SITIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SITIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SITIO actions', async () => {
      const arg = { id: 12844 };
    ...
    it('dispatches UPDATE_SITIO actions', async () => {
      const arg = { id: 12844 };
    ...
    it('dispatches PARTIAL_UPDATE_SITIO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SITIO actions', async () => {
      const arg = 42666;
