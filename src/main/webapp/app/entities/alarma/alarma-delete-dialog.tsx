...
export const AlarmaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="alarmaDeleteDialogHeading">
        <Translate contentKey="entity.delete.title">Confirm delete operation</Translate>
      </ModalHeader>
      <ModalBody id="appsupervisorApp.alarma.delete.question">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-alarma" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
