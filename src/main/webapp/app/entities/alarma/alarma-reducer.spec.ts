...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './alarma.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALARMA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ALARMA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ALARMA actions', async () => {
      const arg = { id: 5632 };
    ...
    it('dispatches UPDATE_ALARMA actions', async () => {
      const arg = { id: 5632 };
    ...
    it('dispatches PARTIAL_UPDATE_ALARMA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ALARMA actions', async () => {
      const arg = 42666;
