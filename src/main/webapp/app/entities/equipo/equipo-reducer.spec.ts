...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './equipo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EQUIPO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EQUIPO actions', async () => {
      const arg = { id: 21995 };
    ...
    it('dispatches UPDATE_EQUIPO actions', async () => {
      const arg = { id: 21995 };
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EQUIPO actions', async () => {
      const arg = 42666;
