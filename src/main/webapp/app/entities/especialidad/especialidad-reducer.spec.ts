...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESPECIALIDAD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ESPECIALIDAD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ESPECIALIDAD actions', async () => {
      const arg = { id: 20529 };
    ...
    it('dispatches UPDATE_ESPECIALIDAD actions', async () => {
      const arg = { id: 20529 };
    ...
    it('dispatches PARTIAL_UPDATE_ESPECIALIDAD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ESPECIALIDAD actions', async () => {
      const arg = 42666;
